...
<div class="head">
  ...
  <div class="container-fluid">
    <a class="navbar-brand" href="home.php">Esparx 2023</a>
...
<form action="wregistrationphp.php" method="post" enctype="multipart/form-data">
...
<select class="form-select" name="select" aria-label="Default select example">
  <option >Work Shop Intrested</option>
  <option value="1">1</option>
  <option value="2">2</option>
  <option value="3">3</option>
  <option value="4">4</option>
...
<div class="file">
<label > Choose the payment proof to upload:</label> <input type="file" 
                  name="my_image">
</div>
  </br>
