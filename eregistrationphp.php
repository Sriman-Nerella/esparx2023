...
if ($error === 0) {
		...
		$allowed_exs = array("jpg", "jpeg", "png"); 
 		if (in_array($img_ex_lc, $allowed_exs)) {
 			...
 			$img_upload_path = 'events_payment/'.$new_img_name;
 			move_uploaded_file($tmp_name, $img_upload_path);
			
		}else {
 			$em = "You can't upload files of this type";
 			echo"<script>alert('You can't upload files of this type');";
 echo"window.location.href='eventss.php';</script>";
 		}
 ...
 $reg="INSERT INTO `events` ( `college name`, `unique id`, `year`, `event name`, `upi number`,`image`) VALUES ('$clg','$id','$year','$selec','$upi','$the')";
